...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (mfaActive) {
      if (!otp || otp.length < 6) {
        setMessage("Veuillez saisir le code OTP à 6 chiffres");
        return;
      }
      setLoading(true);
      try {
        ...
        <div className="login-card" ref={cardRef}>
          ...
          <form onSubmit={handleSubmit} className="login-form">
            {!mfaActive ? (
              ...
              <div className="login-field floating-label mfa-field">
                <label>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                ...
                <input
                  ...
                  required
                  autoFocus
                  className="input-3d otp-input-large"
                />
                <p className="mfa-hint">Veuillez vérifier votre boîte de réception.</p>
              </div>
            )}
