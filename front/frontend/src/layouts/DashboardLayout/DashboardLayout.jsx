...
import AccessBlocked from "../../features/core/pages/AccessBlocked/AccessBlocked";
...
const Sidebar = ({ userRole }) => {
  ...
  const menuItems = [
    ...
    { path: "/MonitoringDashboard", icon: "📊", label: "Monitoring" }
  ];
  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar-menu">
        {userRole === "analyste" && menuItems.map((item, index) => (
          <NavLink
            key={item.path}
            to={item.path}
